...
if sys.version_info.major > 2:
    from tkinter_test import _tkinter as tk
else:
    from Tkinter import tkinter as tk

if hasattr(sys, 'pypy_find_executable'):
    # Tested with packages at https://bitbucket.org/pypy/pypy/downloads.
    # PyPies 1.6, 2.0 do not have tkinter_test built in.  PyPy3-2.3.1 gives an
    # OSError trying to import tkinter_test. Otherwise:
